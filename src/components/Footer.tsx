...
const Footer = () => {
  ...
  const companyInfo = {
    about_text: 'Your trusted technology partner delivering innovative software solutions.',
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1">
            ...
            <div className="flex space-x-4 mt-6">
              ...
              <a
                href={companyInfo.social_links.twitter}
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-all duration-300"
                style={{ color: 'white' }}
              ...
              <a
                href={companyInfo.social_links.linkedin}
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-all duration-300"
                style={{ color: 'white' }}
