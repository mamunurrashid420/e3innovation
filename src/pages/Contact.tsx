...
const Contact = () => {
  ...
  const [appearance, setAppearance] = useState({
    bg_contact_hero: 'https://images.unsplash.com/photo-1423666639041-f56196c273e8?w=1920&q=80',
  });

  useEffect(() => {
    const fetchSettings = async () => {
      try {
        const [footerData, appearanceData] = await Promise.all([
  ...
  return (
    <div className="min-h-screen">
      ...
      <Hero
        ...
        backgroundImage={appearance.bg_contact_hero}
        showCTA={false}
      />
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">BD Office Address</h3>
                    <p className="text-gray-600">{settings.contact_address_bd}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">China Office Address</h3>
                    <p className="text-gray-600">{settings.contact_address_china}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href={`tel:${settings.contact_phone}`} className="hover:text-red-600 transition-colors">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href={`mailto:${settings.contact_email}`} className="hover:text-red-600 transition-colors">
